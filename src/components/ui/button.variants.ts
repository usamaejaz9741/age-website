  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-[var(--font-size-sm)] font-medium leading-none ring-offset-background transition-all duration-300 ease-gentle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:flex-shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "bg-primary text-white hover:bg-primary/90 shadow-medium hover:shadow-strong transform hover:-translate-y-0.5 font-semibold [&>svg]:text-white",
      ...
      size: {
        ...
        xl: "h-14 min-h-[56px] px-8 text-[var(--font-size-base)]",        // 56px height (extra emphasis)
